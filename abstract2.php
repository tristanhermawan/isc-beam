            ...
            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    <div class="xcontainer">
                        <div class="xbutton-panel">
                            <button onclick="rotate('item1')">Review Abstract</button>
                            <button onclick="rotate('item2')">Review Poster</button>
                        </div>
                        <h2>ISC-BEAM 2024 Poster Review Results</h2>
                    </div>
                    <!-- <?php
                        $url = "https://spreadsheets.google.com/tq?key=1pNoy2ZPJz0rcM2NYfbOwNFgdcXna-NSJjVVlqom6_6w&gid=1806837881&tq=SELECT%20C,D,E,L,M,N,O,P&tqx=out:json";
                        ...
                        echo "<thead><tr><th>No</th><th>Paper ID</th><th>Title of Abstract</th><th>Name of author</th><th>Evaluation  Visual Appeal</th><th>Evaluation  Organization and Layout</th><th>Evaluation  Clarity of Content</th><th>Research Content  Research Content</th><th>Evaluation  Quality of Graphics and Charts</th></tr></thead>";
                        echo "<tbody>";
      ...
      function rotate(itemx) {
          ...
          switch (itemx) {
              case 'item1':
                  ...
                  break;
              default:
                  window.location.href = "abstract2.php";
                  break;
          }
      }
  </script>
